...
const EventHandler = {
        ...
        off(e, t, n, i) {
            ...
            if (void 0 !== o) { if (!l || !l[a]) return; return void removeHandler(e, l, a, o, s ? n : null) }
        ...
        trigger(e, t, n) {
            ...
            let r, l = !0,
                ...
                E = !1,
                _ = null;
            return o && i && (r = i.Event(t, n), i(e).trigger(r), l = !r.isPropagationStopped(), c = !r.isImmediatePropagationStopped(), E = r.isDefaultPrevented()), a ? (_ = document.createEvent("HTMLEvents"), _.initEvent(s, l, !0)) : _ = new CustomEvent(t, { bubbles: l, cancelable: !0 }), void 0 !== n && Object.keys(n).forEach(e => { Object.defineProperty(_, e, { get: () => n[e] }) }), E && _.preventDefault(), c && e.dispatchEvent(_), _.defaultPrevented && void 0 !== r && r.preventDefault(), _
        }
    },
    VERSION = "5.0.1";
class BaseComponent {
...
class Carousel extends BaseComponent {
    ...
    _getConfig(e) { return e = {...Default$9, ...e }, typeCheckConfig(NAME$a, e, DefaultType$9), e }
    _handleSwipe() {
    ...
    _keydown(e) { /input|textarea/i.test(e.target.tagName) || ("ArrowLeft" === e.key ? (e.preventDefault(), this._slide(DIRECTION_RIGHT)) : "ArrowRight" === e.key && (e.preventDefault(), this._slide(DIRECTION_LEFT))) }
    ...
    _slide(e, t) {
        ...
        const d = () => { EventHandler.trigger(this._element, EVENT_SLID, { relatedTarget: o, direction: _, from: s, to: a }) };
        if (this._element.classList.contains("slide")) {
            o.classList.add(E), reflow(o), i.classList.add(c), o.classList.add(c);
            const e = () => { o.classList.remove(c, E), o.classList.add("active"), i.classList.remove("active", E, c), this._isSliding = !1, setTimeout(d, 0) };
...
EventHandler.on(document, EVENT_CLICK_DATA_API$5, SELECTOR_DATA_SLIDE, Carousel.dataApiClickHandler), EventHandler.on(window, EVENT_LOAD_DATA_API$2, () => { const e = SelectorEngine.find(SELECTOR_DATA_RIDE); for (let t = 0, n = e.length; t < n; t++) Carousel.carouselInterface(e[t], Data.get(e[t], DATA_KEY$9)) }), defineJQueryPlugin(Carousel);
...
class Dropdown extends BaseComponent {
    ...
    _selectMenuItem(e) { const t = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(isVisible); if (!t.length) return; let n = t.indexOf(e.target); "ArrowUp" === e.key && n > 0 && n--, "ArrowDown" === e.key && n < t.length - 1 && n++, n = -1 === n ? 0 : n, t[n].focus() }
...
const SELECTOR_FIXED_CONTENT = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    ...
    hide = (e = getWidth()) => { _disableOverFlow(), _setElementAttributes("body", "paddingRight", t => t + e), _setElementAttributes(SELECTOR_FIXED_CONTENT, "paddingRight", t => t + e), _setElementAttributes(".sticky-top", "marginRight", t => t - e) },
    _disableOverFlow = () => {
    ...
    reset = () => { _resetElementAttributes("body", "overflow"), _resetElementAttributes("body", "paddingRight"), _resetElementAttributes(SELECTOR_FIXED_CONTENT, "paddingRight"), _resetElementAttributes(".sticky-top", "marginRight") },
    ...
    DefaultType$6 = { isVisible: "boolean", isAnimated: "boolean", rootElement: "element", clickCallback: "(function|null)" },
    NAME$7 = "backdrop",
...
class Backdrop {
    ...
    _getConfig(e) { return (e = {...Default$6, ... "object" == typeof e ? e : {} }).rootElement = e.rootElement || document.body, typeCheckConfig(NAME$7, e, DefaultType$6), e }
    ...
    dispose() { this._isAppended && (EventHandler.off(this._element, EVENT_MOUSEDOWN), this._getElement().parentNode.removeChild(this._element), this._isAppended = !1) }
    _emulateAnimation(e) {
...
class Modal extends BaseComponent {
    constructor(e, t) { super(e), this._config = this._getConfig(t), this._dialog = SelectorEngine.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1 }
    ...
    _getConfig(e) { return e = {...Default$5, ...Manipulator.getDataAttributes(this._element), ...e }, typeCheckConfig(NAME$6, e, DefaultType$5), e }
    _showElement(e) {
        const t = this._isAnimated(),
...
EventHandler.on(document, EVENT_CLICK_DATA_API$2, SELECTOR_DATA_TOGGLE$2, (function(e) {
    const t = getElementFromSelector(this);
    ["A", "AREA"].includes(this.tagName) && e.preventDefault(), EventHandler.one(t, EVENT_SHOW$3, e => { e.defaultPrevented || EventHandler.one(t, EVENT_HIDDEN$3, () => { isVisible(this) && this.focus() }) }), (Modal.getInstance(t) || new Modal(t)).toggle(this)
...
class Offcanvas extends BaseComponent {
    ...
    toggle(e) { return this._isShown ? this.hide() : this.show(e) }
    show(e) { this._isShown || EventHandler.trigger(this._element, EVENT_SHOW$2, { relatedTarget: e }).defaultPrevented || (this._isShown = !0, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || (hide(), this._enforceFocusOnElement(this._element)), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add("show"), this._queueCallback(() => { EventHandler.trigger(this._element, EVENT_SHOWN$2, { relatedTarget: e }) }, this._element, !0)) }
    hide() { this._isShown && (EventHandler.trigger(this._element, EVENT_HIDE$2).defaultPrevented || (EventHandler.off(document, EVENT_FOCUSIN$1), this._element.blur(), this._isShown = !1, this._element.classList.remove("show"), this._backdrop.hide(), this._queueCallback(() => { this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || reset(), EventHandler.trigger(this._element, EVENT_HIDDEN$2) }, this._element, !0))) }
...
})), EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => { SelectorEngine.find(OPEN_SELECTOR).forEach(e => (Data.get(e, DATA_KEY$5) || new Offcanvas(e)).show()) }), defineJQueryPlugin(Offcanvas);
...
function sanitizeHtml(e, t, n) {
    ...
    for (let e = 0, n = o.length; e < n; e++) {
        ...
        const a = [].concat(...n.attributes),
            r = [].concat(t["*"] || [], t[i] || []);
        a.forEach(e => { allowedAttribute(e, r) || n.removeAttribute(e.nodeName) })
    }
...
class Tooltip extends BaseComponent {
    ...
    dispose() { clearTimeout(this._timeout), EventHandler.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.tip && this.tip.parentNode && this.tip.parentNode.removeChild(this.tip), this._popper && this._popper.destroy(), super.dispose() }
    show() {
